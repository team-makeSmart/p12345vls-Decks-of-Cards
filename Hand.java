 ...
 * The Class Hand
 *
 * @author Hunter Mason, Jake McGhee, Mac Doussias, Pavlos Papadonikolakis CLASS
 *         CST338 Assignment 3, Module 3
 */
...
public class Hand {
     ...
     */
    public void resetHand() // TODO Does this needs more? Need delete cards from
    // myCards array?
    {
        numCards = 0;
    }
    ...
    public boolean takeCard(Card card) {
        if (numCards < MAX_CARDS) {
            // Makes a copy of new card and stores in index. Then increments
            // numCards.
            myCards[numCards++] = new Card(card.getValue(), card.getSuit());
            
            if (numCards == MAX_CARDS) // The hand is full
            {
                // TODO takeCard should not print to screen. It should just
                // return true/false
                // TODO printing to the screen should be handled in the main()
                // part of the program
                // TODO Changes here will affect main() as well and will need
                // changes in main() too
                System.out.println("\nHand Full\nAfter Deal");
                return false;
            }
     ...
     * @return the card
     */
    Card playCard() // TODO is this deleting from the array for cards? Card
    // values still left in array
    {
